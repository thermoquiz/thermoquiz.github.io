...
function test(){
	...
	QTN = "Masa molar <br>de " + symbols[z];
	ANS = PM[z];
	uni = "g/mol";
...
function loadData(){
	...
	symbols[1]="KNO<sub>3</sub>";				PM[1]=39.1 + 14.01 + 3*16;
	symbols[2]="KBr";							PM[2]=39.1 + 79.9;
	symbols[3]="CH<sub>4</sub>";				PM[3]=12.01 + 4*1.01;
	symbols[4]="NH<sub>3</sub>";				PM[4]=14.01 + 3*1.01;
	symbols[5]="H<sub>2</sub>O";				PM[5]=2*1.01 + 16;
	symbols[6]="C<sub>6</sub>H<sub>12</sub>O<sub>6</sub>";		PM[6]=6*12.01 + 12*1.01 + 6*16;
	symbols[7]="C<sub>6</sub>H<sub>8</sub>O<sub>7</sub>";		PM[7]=6*12.01 + 8*1.01 + 7*16;
	symbols[8]="H<sub>2</sub>";									PM[8]=2*1.01;
	symbols[9]="C<sub>2</sub>H<sub>2</sub>Cl<sub>2</sub>";		PM[9]=2*12.01 + 2*1.01 + 2*35.45;
	symbols[10]="LiF";											PM[10]=6.94 + 19;
	symbols[11]="CO";											PM[11]=12.01 + 16;
	symbols[12]="C<sub>17</sub>H<sub>19</sub>NO<sub>3</sub>";	PM[12]=17*12.01 + 19*1.01 + 14.01 + 3*16;
	symbols[13]="C<sub>2</sub>H<sub>6</sub>";					PM[13]=2*12.01 + 6*1.01;
	symbols[14]="O<sub>2</sub>";								PM[14]=2*16;
	symbols[15]="H<sub>2</sub>O<sub>2</sub>";					PM[15]=2*1.01 + 2*16;
	symbols[16]="C<sub>12</sub>H<sub>22</sub>O<sub>11</sub>";	PM[16]=12*12.01 + 22*1.01 + 11*16;
	symbols[17]="HCl";											PM[17]=1.01 + 35.45;
	symbols[18]="F<sub>2</sub>";								PM[18]=2*19;
	symbols[19]="NaOH";											PM[19]=22.99 + 16 + 1.01;
	symbols[20]="C<sub>3</sub>H<sub>6</sub>";					PM[20]=3*12.01 + 6*1.01;
	symbols[21]="CO<sub>2</sub>";								PM[21]=12.01 + 2*16;
	symbols[22]="CH<sub>3</sub>CH<sub>2</sub>OH";				PM[22]=12.01 + 3*1.01 + 12.01 + 2*1.01 + 16 + 1.01;
	symbols[23]="O<sub>3</sub>";								PM[23]=3*16;
	symbols[24]="NaCl";											PM[24]=22.99 + 35.45;
	symbols[25]="CH<sub>3</sub>COOH";							PM[25]=12.01 + 3*1.01 + 12.01 + 16 + 16 + 1.01;
	symbols[26]="HNO<sub>3</sub>";								PM[26]=1.01 + 14.01 + 3*16;
	symbols[27]="Cl<sub>2</sub>";								PM[27]=2*35.45;

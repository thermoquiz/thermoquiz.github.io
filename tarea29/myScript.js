 ...
 * */
	...
	let opt, opt2;
	let molesA, molesB, molesC, molesD;
	let gramosA, gramosB, gramosC, gramosD;
	let show_the_answer = false;

	opt = rndi(1,4);
	opt2 = rndi(1,3);
	molesA = rndi(2,20);
	gramosA = rndi(2,20)*10;
	
	// opt = 1;
	// opt2 = 4;
	
	if(opt===1){ //CH4 + 2 O2 -> CO2 + 2 H2O
		a = 1; CA = "CH<sub>4</sub>"; PMA = 12.01 + 4*1.01;
		b = 2; CB = "O<sub>2</sub>"; PMB = 2*16;
		c = 1; CC = "CO<sub>2</sub>"; PMC = 12.01 + 2*16;
		d = 2; CD = "H<sub>2</sub>O"; PMD = 2*1.01 + 16;
	}
	if(opt===2){ //2 C2H6 + 7 O2 -> 4 CO2 + 6 H2O
		a = 2; CA = "C<sub>2</sub>H<sub>6</sub>"; PMA = 2*12.01 + 6*1.01;
		b = 7; CB = "O<sub>2</sub>"; PMB = 2*16;
		c = 4; CC = "CO<sub>2</sub>"; PMC = 12.01 + 2*16;
		d = 6; CD = "H<sub>2</sub>O"; PMD = 2*1.01 + 16;
	}
	if(opt===3){ //C6H12O6 + 6 O2 -> 6 CO2 + 6 H2O
		a = 1; CA = "C<sub>6</sub>H<sub>12</sub>O<sub>6</sub>"; PMA = 6*12.01 + 12*1.01 + 6*16;
		b = 6; CB = "O<sub>2</sub>"; PMB = 2*16;
		c = 6; CC = "CO<sub>2</sub>"; PMC = 12.01 + 2*16;
		d = 6; CD = "H<sub>2</sub>O"; PMD = 2*1.01 + 16;
	}
	if(opt===4){ //2 CH3OH + 3 O2 -> 2 CO2 + 4 H2O
		a = 2; CA = "CH<sub>3</sub>OH"; PMA = 12.01 + 4*1.01 + 16;
		b = 3; CB = "O<sub>2</sub>"; PMB = 2*16;
		c = 2; CC = "CO<sub>2</sub>"; PMC = 12.01 + 2*16;
		d = 4; CD = "H<sub>2</sub>O"; PMD = 2*1.01 + 16;
	}
	
	if(opt2===1){
		QTN  = "<b>"+a+CA+" + "+b+CB+" &rarr; "+c+CC+" + "+d+CD+"</b>"+"<br><br>";
		QTN += "Se queman "+molesA+" mol de "+CA+".<br>";
		QTN += "¿Cuántos moles de "+CB+" se necesitan?<br>";
		
		molesB = molesA * b/a; uni="mol";
		ANS = molesB;	
		
		if(show_the_answer){
			console.log("molesB: ", molesB);
		}
	...
	if(opt2===2){
		QTN  = "<b>"+a+CA+" + "+b+CB+" &rarr; "+c+CC+" + "+d+CD+"</b>"+"<br><br>";
		QTN += "Se queman "+molesA+" mol de "+CA+".<br>";
		QTN += "¿Cuántos moles de "+CC+" se producen?<br>";
		
		molesC = molesA * c/a; uni="mol";
		ANS = molesC;	
		
		if(show_the_answer){
			console.log("molesC: ", molesC);
		}
	...
	if(opt2===3){
		QTN  = "<b>"+a+CA+" + "+b+CB+" &rarr; "+c+CC+" + "+d+CD+"</b>"+"<br><br>";
		QTN += "Se queman "+molesA+" mol de "+CA+".<br>";
		QTN += "¿Cuántos moles de "+CD+" se producen?<br>";
		
		molesD = molesA * d/a; uni="mol";
		ANS = molesD;	
		
		if(show_the_answer){
			console.log("molesD: ", molesD);
		}
		
	}
	if(opt2===4){
		QTN  = "<b>"+a+CA+" + "+b+CB+" &rarr; "+c+CC+" + "+d+CD+"</b>"+"<br><br>";
		QTN += "Se queman "+gramosA+" gramos de "+CA+".<br>";
		QTN += "¿Cuántos gramos de "+CB+" se necesitan?<br>";
		
		molesA = round2(gramosA/PMA);
		molesB = round2(molesA*b/a);
		gramosB = round2(molesB*PMB);
		ANS = gramosB;	uni="g";
		
		if(show_the_answer){
			console.log("molesA: ", molesA);
			console.log("molesB: ", molesB);
			console.log("gramosB: ", gramosB);
		}
	...
	if(opt2===5){
		QTN  = "<b>"+a+CA+" + "+b+CB+" &rarr; "+c+CC+" + "+d+CD+"</b>"+"<br><br>";
		QTN += "Se queman "+gramosA+" gramos de "+CA+".<br>";
		QTN += "¿Cuántos gramos de "+CC+" se producen?<br>";
		
		molesA = round2(gramosA/PMA);
		molesC = round2(molesA*c/a);
		gramosC = round2(molesC*PMC);
		ANS = gramosC; uni="g";
		
		if(show_the_answer){
			console.log("molesA: ", molesA);
			console.log("molesC: ", molesC);
			console.log("gramosC: ", gramosC);
		}
	...
	if(opt2===6){
		QTN  = "<b>"+a+CA+" + "+b+CB+" &rarr; "+c+CC+" + "+d+CD+"</b>"+"<br><br>";
		QTN += "Se queman "+gramosA+" gramos de "+CA+".<br>";
		QTN += "¿Cuántos gramos de "+CD+" se producen?<br>";
		
		molesA = round2(gramosA/PMA);
		molesD = round2(molesA*d/a);
		gramosD = round2(molesD*PMD);
		ANS = gramosD; uni="g";

		if(show_the_answer){
			console.log("molesA: ", molesA);
			console.log("molesD: ", molesD);
			console.log("gramosD: ", gramosD);
		}		
...
function showAns(){
	...
	fkans[1] = round2(ANS * 0.6)+" " + uni;
	fkans[2] = round2(ANS * 1.8) +" " + uni;

...
function test(){
	...
	if(opt===1){
		...
		QTN = "Una muestra de "+m+" g de una sustancia<br>desconocida ocupa un volumen de "+V+" mL.<br>";
		QTN += "Calcula la densidad de dicha sustancia.<br><br>";
	...
	if(opt===2){
		...
		QTN = "La densidad de un material es de "+d+" g/mL.<br>";
		QTN += "Calcula el volumen de "+m+" g de dicho material.<br><br>";
	...
	if(opt===3){
		...
		QTN = "La densidad de una sustancia es de "+d+" g/mL.<br>";
		QTN += "Calcula la masa de "+V+" mL de dicha sustancia.<br><br>";
...
function gameover(){
	...
	firma[3] = R[2];firma[4] = R[3];firma[5]=hh+7;
	...
	resumen +="Firma: "+firma[0]+","+firma[5]+","+firma[3]+","+firma[1]+","+firma[4]+","+firma[2]+".<br>";

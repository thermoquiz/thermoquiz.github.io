...
function isobarico(op)
{
	...
	if(op===1)
	{
        ...
        QTN  = "Un mol de gas ideal se somete a un proceso isobárico ("+P+" kPa). ";
	...
	if(op===2)
	{
        ...
        QTN  = "Un mol de gas ideal (C<sub>p</sub> = "+Cp+" J/K) se somete a un proceso isobárico. ";
	...
	if(op===3)
	{
        ...
        QTN  = "Un mol de gas ideal, a "+T1+" °C, se somete a un proceso isobárico, ";

...
function test(){
	...
	let opt, opt2;
	let moles, gramos, litros, mililitros, molaridad;
	let show_the_answer = false;
	
	let FORMULA, NOMBRE, PM;
	...
	if(opt2===1){
		...
		QTN  = "Se disuelven "+moles+" moles de "+NOMBRE+" ("+FORMULA+") en "+litros+" litros de agua. <br>";
	...
	if(opt2===2){
		...
		while(1){
			gramos = rndi(10,50)*10;
			moles = gramos_a_mol(PM, gramos);
			litros = rndi(1,10);
			molaridad = moles/litros;
			if(molaridad >=1) break;
		}
		
		QTN  = "Se disuelven "+gramos+" gramos de "+NOMBRE+" ("+FORMULA+") en "+litros+" litros de agua. <br>";
		QTN += "¿Cuál es la molaridad de la disolución?<br><br>";
		...
		if(show_the_answer){
			console.log("moles: ", moles, "molaridad :", molaridad);
		}
	...
	if(opt2===3){
		...
		while(1){
			gramos = rndi(10,50)*10;
			moles = gramos_a_mol(PM, gramos);
			mililitros = rndi(1,25)*100;
			litros = mililitros/1000;
			molaridad = moles/litros;
			if(molaridad >=1) break;
		}
		
		QTN  = "Se disuelven "+gramos+" gramos de "+NOMBRE+" ("+FORMULA+") en "+mililitros+" mililitros de agua. <br>";
		QTN += "¿Cuál es la molaridad de la disolución?<br><br>";
	...
	if(opt2===4){
		...
		while(1){
			molaridad = rndi(10,25)/10.0;
			litros = rndi(2,5);
			moles = molaridad*litros;
			if(moles >= 1) break;
		}
		
		QTN  = "Se tienen "+litros+" litros de una disolución "+molaridad+" M de "+NOMBRE+" ("+FORMULA+"). <br>";
		QTN += "¿Cuántos moles de "+NOMBRE+" hay en la disolución?<br><br>";
	...
	if(opt2===6){
		...
		while(1){
			...
			moles = gramos_a_mol(PM, gramos);
			molaridad = rndi(10,25)/10.0;
			litros = moles/molaridad;
			if(litros >=1) break;
		}
		
		QTN  = "Se tienen "+gramos+" gramos de "+NOMBRE+" ("+FORMULA+"). <br>";
		QTN += "Se desea preparar una disolución "+molaridad+" M. <br>";
		QTN += "¿Cuántos litros de agua son necesarios?<br><br>";
